...
const  AbsenceRequestDetials = ({request}) => {
    ...
    return ( 
        <div>
            <Card bg="dark" text="light">
                ...
                <ListGroup>
                    <ListGroup.Item style={{backgroundColor : 'blue'}}>Pharmacist : {request.userEmail}</ListGroup.Item>
...
export default AbsenceRequestDetials ;